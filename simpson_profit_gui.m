function simpson_profit_gui
  ...
  f = figure('Name', 'Numerical Analysis Project: Simpson''s Rule Profit Analyzer', ...
             'Position', [300 100 800 600], 'Color', [0.96 0.96 0.98], ...
             'NumberTitle', 'off', 'MenuBar', 'none');

  % Create main title panel
  uipanel('Title', '', 'Position', [0.05 0.85 0.9 0.12], ...
         'BackgroundColor', [0.92 0.92 0.98], 'BorderType', 'line');

  % Title text
  uicontrol(f, 'Style', 'text', 'Position', [50 550 700 40], ...
  ...
  % Subtitle text
  uicontrol(f, 'Style', 'text', 'Position', [50 530 700 20], ...
  ...
  show_grid = uicontrol(options_panel, 'Style', 'checkbox', ...
                       'Position', [220 10 150 20], ...
                       'String', 'Show grid', ...
                       'Value', 1, 'FontSize', 10, ...
                       'BackgroundColor', [0.95 0.95 0.97]);

  % Time period label
  uicontrol(options_panel, 'Style', 'text', 'Position', [380 10 100 20], ...
  ...
  uicontrol(f, 'Style', 'pushbutton', 'String', 'Calculate Total Profit', ...
            'Position', [300 140 200 35], 'FontSize', 12, 'FontWeight', 'bold', ...
  ...
  uicontrol(f, 'Style', 'pushbutton', 'String', 'Export Results', ...
            'Position', [520 140 150 35], 'FontSize', 11, ...
            'Callback', @export_results);

  % Help button
  uicontrol(f, 'Style', 'pushbutton', 'String', '?', ...
            'Position', [690 140 30 35], 'FontSize', 11, ...
            'Callback', @show_help);
